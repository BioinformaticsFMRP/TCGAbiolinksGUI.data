...
## Installing and TCGAbiolinksGUI.data
...
The code below downloads a manifest of MAF files available in the NCI's Genomic Data Commons (GDC).
```{r, eval=FALSE, include=TRUE}
...
1) RF to classify between IDHmut and IDHwt:
...
3) RF to classify between G-CIMP-low and G-CIMP-high (Fig S3C):
